...
public class QueryPlan {
	...
	private QueryPlan(List<String> attributes, List<String> relations, List<String> conditions){
	...
	public static QueryPlan parse(String q) throws Exception {
		...
		QueryPlan query = new QueryPlan(splitAndTrim(selections, ","), splitAndTrim(relations, ","), splitAndTrim(joincond, " and "));
		return query;
	}
